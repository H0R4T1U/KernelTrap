...
\begin{itemize}
  \item \textbf{NIDS} (\textit{Network-based IDS}): monitorizează traficul de rețea la nivel de
  ...
  \item \textbf{HIDS} (\textit{Host-based IDS}): rulează direct pe gazda monitorizată și analizează
...
compatibilitatea între versiuni diferite de kernel.
